...
/** Kept apart from the server's data/checkpoints.sqlite so exercises never touch real stories. */
export const LEARNING_DIR = join(import.meta.dirname, "..", "..", "..", "data", "learning");

process.env["LANGSMITH_TRACING"] = "false";
await mkdir(LEARNING_DIR, { recursive: true });
const saver = SqliteSaver.fromConnString(join(LEARNING_DIR, "checkpoints.sqlite"));
